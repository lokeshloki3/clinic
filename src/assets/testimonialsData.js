const reviews = [
  ...
  //   text: "Cortihear has been amazing for my little ones cochlear implant services. The Lead Audiologist turned the auditory verbal therapy sessions into a fun adventure! He was struggling with speech, but now he is confident and chatting away. It is a joy to see!",
  // },
  // {
  //   id: 7,
  //   name: "Kiran Joshi",
  //   image: "https://aeccc.targettechnology.in/static/media/AbirPal.574a09ad7cb325853b29.jpg",
  //   text: "I was really unsure about getting cochlear implant services, but the team at Cortihear, especially The Lead Audiologist, made it all feel comfortable. Their auditory verbal therapy has helped me hear my favorite songs again. Best decision ever!",
  // },
  // {
  //   id: 8,
  //   name: "Pooja Nair",
  //   image: "https://aeccc.targettechnology.in/static/media/SoumyaBanerjee.2e2521d6029842435080.jpg",
  //   text: "After years of feeling frustrated with my speech, I found the team at Cortihear, and The Lead Audiologist really understood me. The auditory verbal therapy has helped me find my voice again, and I cannot believe how far I have come thanks to their support!",
  // },
  // {
  //   id: 9,
  //   name: "Siddharth Mehta",
  //   image: "https://aeccc.targettechnology.in/static/media/SaikatMukherjee.033310703edff52d0532.jpg",
  //   text: "Cortihear has been such a blessing for my son! The Lead Audiologist and the team made the auditory verbal therapy sessions so engaging and fun. Now he is making friends and talking like a champ. I could not be happier!",
  // },
  // {
  //   id: 10,
  //   name: "Devika Chatterjee",
  //   image: "https://avatars.githubusercontent.com/u/93366359?v=4",
  //   text: "I have struggled with hearing problems my whole life, but The Lead Audiologist and the team at Cortihear made everything easier. Their auditory verbal therapy helped me find the right hearing aids. Now I can enjoy conversations again, and it feels great!",
  // },
];
