      ...
      <div>
        <div className="my-10 flex flex-col md:flex-row gap-12">
          ...
          <p className="text-base md:text-lg md:mt-3">
            The founder, an accomplished Audiologist and Speech-Language Pathologist,
        ...
        <div className="flex flex-col justify-center gap-3 md:w-3/4 mx-auto text-sm text-gray-600">
          <p className="text-base md:text-lg">
            ...
            screen. With the guidance of our lead Audiologist, a dedicated Audiologist and Speech Language
